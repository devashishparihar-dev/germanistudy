    ...
    <aside className="sidebar" style={{ background: 'var(--sidebar-bg)', color: 'white' }}>
      <div className="sidebar-header" style={{ padding: '24px' }}>
        <div style={{ display: 'flex', alignItems: 'center', marginBottom: '8px' }}>
          <img src="/assets/branding/logo_light.png" alt="GermaniStudy Logo" className="logo-light-mode" style={{ height: '120px', objectFit: 'contain' }} />
          <img src="/assets/branding/logo_dark.png" alt="GermaniStudy Logo" className="logo-dark-mode" style={{ height: '120px', objectFit: 'contain' }} />
        </div>
